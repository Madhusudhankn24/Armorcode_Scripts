...
import ArmorcodepageObjects.FindingspageObjects;
import ArmorcodepageObjects.ScanspageObjects;
...
public class Findings
{
	...
	public FindingspageObjects fe1;
	public ScanspageObjects ele;
...
//		fe1=new Findings_elements(driver1);
		fe1=new FindingspageObjects(driver);
		fe1.scanstab();
		fe1.findingtab();
	}
	...
	public void click_on_add_finding_and_fill_details() throws InterruptedException 
	{
		...
		fe1.subproduct();
		fe1.sptest2o();
		ScanspageObjects ele =new ScanspageObjects(driver);
		ele.environmentdd();
...
public void check_files_is_displayed_in_details_tab() 
{
	...
	{
		fe1.clear();
	   ele=new ScanspageObjects(driver);
	   fe1.product_filter();
	   fe1.search_fe();
