...
import pom_armorcode.productobject;
...
public class product {
	...
	product=new productobject(driver);
	@When("naviget to armorcode application")
	public void naviget_to_armorcode_application() throws InterruptedException {
	...
	public void click_on_product_option() throws InterruptedException {
		Thread.sleep(5000);
		product.products();
	   }
